...
namespace Piraeus.Grains.Notifications
{
    public class EventHubSink : EventSink
    {
        ...
        private EventHubSender[] senderArray;
            ...
            : base(metadata)
        {
            ...
            {
                senderArray = new EventHubSender[clientCount];
            }
            ...
            {
                storageArray[i] = EventHubClient.CreateFromConnectionString(connectionString, hubName);
                if (!String.IsNullOrEmpty(partitionId))
                {
                    senderArray[i] = storageArray[i].CreatePartitionedSender(partitionId);
                }
            }
